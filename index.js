...
const handleSearch = () => {
  ...
  axios
    ...
    .then(function (response) {
      ...
      if (superHero !== "Hero Not Found") {
        document.getElementById("result-container").innerHTML = `
          <div class="flex flex-col md:flex-row md:justify-evenly bg-gray-200 md:h-screen">
          <div>
            <img
    ...
    `;
        ...
        document.getElementById("result-container").innerHTML =
          "<p class='w-96 h-96 flex justify-center items-center bg-gray-100'>No Hero Found!</p>";
      }
    })
